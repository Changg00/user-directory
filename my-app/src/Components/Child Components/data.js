    ...
    return(
      ...
      <div id='jobInfo'>
        ...
        <div id='from'>
          ...
          {`${data[this.props.counter].city}, ${data[this.props.counter].country}`} </p>
        </div>

      <div id='jobTitle'>
        <p> <span class="bold"> {`Job Title:`} </span>
        {`${data[this.props.counter].title}`} </p>
      </div>

      <div id='employer'>
        <p> <span class="bold"> {`Employer:`} </span> {`${data[this.props.counter].employer}`}
        </p>
      </div>
